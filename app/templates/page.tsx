  ...
  return (
    <main>
      <section className="hero" style={{ paddingBottom: '10px' }}>
        <h1>Templates</h1>
        <p>Each template has its own description page and server-owned access rule. Free sessions open immediately; holder/pro/collector sessions unlock after Phantom signature and balance verification.</p>
        <div id="auth-root" />
      </section>
